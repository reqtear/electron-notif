...
export default function Sidebar({ outlet }) {
  ...
  return (
    <>
      ...
      <div
        className={
          'z-30 fixed top-0 left-0 right-0 bottom-0 bg-slate-600/50 ' +
          overlayClass
        }
      ></div>
      ...
      <div className="flex">
        <aside
          id="logo-sidebar"
          className={
            'fixed z-40 w-56 bg-white h-screen pt-16 shadow-sm transition-transform -translate-x-full border-gray-300 ' +
            sideBarClass
          }
          aria-label="Sidebar"
        >
            ...
            <ul className="space-y-2 font-medium">
              {localStorage.getItem('role') == 'admin' && (
                <li>
                  <Link
                    to="/"
                    className={
                      'flex items-center p-2 text-gray-900 rounded-lg hover:bg-slate-200 group ' +
                      (location.pathname == '/admin' && routeActiveClass)
                    }
                  >
                    <UserOutlined />
              ...
              <li>
                <Link
                  ...
                  className={
                    'flex items-center p-2 text-gray-900 rounded-lg hover:bg-slate-200 group ' +
                    (location.pathname == '/operator' && routeActiveClass)
                  }
                >
                  <UserOutlined />
                  <span className="ms-3">Otorisasi</span>
                </Link>
              </li>
              <li>
                <Link
                  ...
                  className={
                    'flex items-center p-2 text-gray-900 rounded-lg hover:bg-slate-200 group ' +
                    (location.pathname == '/table/table-view' &&
                      routeActiveClass)
                  }
                >
                  <LogoutOutlined />
        ...
        <div
          className={'p-8 mt-10 w-full bg-slate-100 h-screen ' + contentClass}
        >
          {outlet}
